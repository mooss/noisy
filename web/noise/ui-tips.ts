export const tips = {
    simplex: "Raw simplex noise, the foundamental terrain generation building block. Creates a landscape of smooth hills.",
    ...
    layered_simplex: "Multiple values (called octaves) of simplex noise layered on top of each other. Creates a more complex hilly terrain than plain simplex noise, with each octave adding more details.",
    layered_ridge: "Multiple values (called octaves) of simplex noise layered on top of each other. Creates a more complex mountaineous terrain than plain ridge noise, with each octave adding more details.",
    ...
    continental_mix: "Layered simplex noise and layered ridge noise combined together. The ridge part is what dictates the general shape of the terrain, whereas the simplex part influences the lower part of the terrain. The result is a montaineous terrain with the lower elevations made of hills.",
    ...
    terracing_constant: "Use the same amount of terraces everywhere. Generates a blocky terrain with evenly-spaced terrain.",
    terracing_steps: "Number of terraces used in the terrain. More terraces will create a smoother terrain.",
    terracing_noisy: "Use a different amount of terraces in different places. Creates a stepped and wobbly surface that increases in wobbleliness when the difference between the minimum and the maximum of terraces increases.",
    ...
    tiling: "Groups neighboring coordinates together to form chunks of uniform height. Can create shapes looking like continents.",
