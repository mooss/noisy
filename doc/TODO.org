...
95-        const res = new Uint8ClampedArray(this.width * this.height * 3);
96-        const color = new THREE.Color();
97-
98:        let idx = 0; //TODO: harmonize matrix layout everywhere, this is garbage.
99-        for (const [height] of this.heightMatrix()) {
100-            this.params.palette.lerp(height, color);
101-            color.convertLinearToSRGB();
